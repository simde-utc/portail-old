    ...
    <tfoot>
      <tr>
        ...
        <td>
          ...
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Supprimer', 'event/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Voulez-vous vraiment supprimer définitivement cet événement ?', 'class' => 'btn btn-danger')) ?>
          <?php endif; ?>
        </td>
      </tr>
    </tfoot>
