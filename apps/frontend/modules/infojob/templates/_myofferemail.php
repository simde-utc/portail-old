                                                ...
                                                <td  class="w580"  width="580">
                                                    ...
                                                    <table class="w580"  width="580" cellpadding="0" cellspacing="0" border="0">
                                                        <tbody>                                                            
                                                            <tr>
                                                                <td class="w580"  width="580">
                                                                    <h2 style="color:#0E7693; font-size:22px; padding-top:12px;">Votre annonce sur InfoJob</h2>

                                                                    <div align="left" class="article-content">
                                                                        <p>Afin de modifier ou de retirer votre annonce "<?php echo $annonce->getTitre(); ?>" du service InfoJob, vous pouvez suivre le lien suivant : <a href="<?php echo url_for('infojob/edit?key=' . $annonce->getEmailkey(), true); ?>"><?php echo url_for('infojob/edit?key=' . $annonce->getEmailkey(), true); ?></a></p>
                                                                        <br/>
