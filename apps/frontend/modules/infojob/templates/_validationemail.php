                                                            ...
                                                            <tr>
                                                                <td class="w580"  width="580">
                                                                    ...
                                                                    <div align="left" class="article-content">
                                                                        <p>Activez votre annonce en cliquant sur le lien suivant : <a href="<?php echo url_for('infojob/activate?key=' . $annonce->getEmailkey(), true); ?>"><?php echo url_for('infojob/activate?key=' . $annonce->getEmailkey(), true); ?></a></p>
