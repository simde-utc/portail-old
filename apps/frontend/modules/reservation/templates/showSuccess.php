...
<div class="part" id="reservation">
  ...
  <div class="row-fluid">
	...
	<p><i class="fa fa-home fa-2x fa-fw"></i>Créé par <?php echo $reservation->getIdUserReserve(); ?> pour <a href="<?php echo url_for('assos_show', array('login' => $reservation->getAsso()->getLogin()))?>"><?php echo ucfirst($reservation->getAsso()) ;?></a></p>
  </div>
