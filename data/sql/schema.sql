...
CREATE TABLE article (id BIGINT AUTO_INCREMENT, asso_id BIGINT NOT NULL, name VARCHAR(200) NOT NULL, text TEXT NOT NULL, is_weekmail TINYINT(1) DEFAULT '0', image TEXT, summary VARCHAR(150), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX asso_id_idx (asso_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE asso (id BIGINT AUTO_INCREMENT, name VARCHAR(50), login VARCHAR(32), pole_id BIGINT, type_id BIGINT, url_site VARCHAR(100), description TEXT, logo VARCHAR(100), active TINYINT(1), passation TINYINT(1), salle VARCHAR(6), phone VARCHAR(15), facebook TEXT, summary VARCHAR(150), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX pole_id_idx (pole_id), INDEX type_id_idx (type_id), PRIMARY KEY(id)) ENGINE = INNODB;
