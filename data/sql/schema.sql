CREATE TABLE activation (id BIGINT AUTO_INCREMENT, user_id BIGINT, activation_key TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE article (id BIGINT AUTO_INCREMENT, asso_id BIGINT NOT NULL, name VARCHAR(200) NOT NULL, text TEXT NOT NULL, is_weekmail TINYINT(1) DEFAULT '0', image TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX asso_id_idx (asso_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE asso (id BIGINT AUTO_INCREMENT, name VARCHAR(50), login VARCHAR(32), pole_id BIGINT, type_id BIGINT, url_site VARCHAR(100), description TEXT, logo VARCHAR(100), active TINYINT(1), passation TINYINT(1), salle VARCHAR(6), phone VARCHAR(15), facebook TEXT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX pole_id_idx (pole_id), INDEX type_id_idx (type_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE role (id BIGINT AUTO_INCREMENT, name VARCHAR(50), sort INT, bureau TINYINT(1) DEFAULT '0' NOT NULL, droits BIGINT DEFAULT 0 NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
