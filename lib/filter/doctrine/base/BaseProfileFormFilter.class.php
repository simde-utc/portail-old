...
abstract class BaseProfileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'branche_id'         => new sfWidgetFormFilterInput(),
      'filiere_id'         => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'branche_id'         => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'filiere_id'         => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
