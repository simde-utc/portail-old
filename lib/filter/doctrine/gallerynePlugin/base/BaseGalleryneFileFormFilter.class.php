...
/**
 * GalleryneFile filter form base class.
 *
 * @package    simde
 * @subpackage filter
 ...
 */
abstract class BaseGalleryneFileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('galleryne_file_filters[%s]');
