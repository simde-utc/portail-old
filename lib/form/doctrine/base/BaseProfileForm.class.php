...
abstract class BaseProfileForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'semestre'           => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Semestre'), 'add_empty' => true)),
...
>>>>>>> 9a945a1ee42da6f33934b1a8509aef508f9e2e4c
    ...
    $this->setValidators(array(
      ...
      'semestre'           => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Semestre'), 'required' => false)),
