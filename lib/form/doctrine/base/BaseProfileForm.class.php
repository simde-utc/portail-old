...
abstract class BaseProfileForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'branche_id'         => new sfWidgetFormInputText(),
      'filiere_id'         => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'branche_id'         => new sfValidatorInteger(array('required' => false)),
      'filiere_id'         => new sfValidatorInteger(array('required' => false)),
