...
abstract class BaseProfileForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'semestre'           => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('UserSemestre'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'semestre'           => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('UserSemestre'), 'required' => false)),
      ...
      'devise'             => new sfValidatorString(array('max_length' => 300, 'required' => false)),
